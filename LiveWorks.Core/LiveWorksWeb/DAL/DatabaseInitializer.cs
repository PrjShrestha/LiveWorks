    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "admin@123", "Inbuilt Administrator", "admin@liveworks.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await CreateUserAsync("user", "user@123", "Inbuilt Standard User", "user@liveworks.com", "+1 (123) 000-0001", new string[] { userRoleName });
